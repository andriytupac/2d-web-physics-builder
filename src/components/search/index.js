...
const Search = props => {
    ...
    const { updateInfoModal, changeActiveOpacity } = useStoreActions(
    ...
    return (
        <div>
            <Input className="search-input" icon='search' value={search} placeholder='Search...' size="mini" onChange={searchChange} />
            <Popup
                trigger={
                    <Button
                        type="button"

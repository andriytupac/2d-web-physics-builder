...
const circle = [{ name: 'x' }, { name: 'y' }, { name: 'radius' }];
const polygon = [{ name: 'x' }, { name: 'y' }, { name: 'sides' }, { name: 'radius' }, { name: 'chamfer.radius' }];
const rectangle = [{ name: 'x' }, { name: 'y' }, { name: 'width' }, { name: 'height' }, { name: 'chamfer.radius' }];
const trapezoid = [
	{ name: 'x' },
	{ name: 'y' },
	{ name: 'width' },
...
const fromVertices = [{ name: 'x' }, { name: 'y' }];
...
const renderVertices = props => {
	...
	return (
		<>
			...
			<Button type="button" color="orange" size="mini" onClick={() => fields.push({})}>
				Add vertices
			</Button>
		</>
	);
...
const AddBodiesContainer = props => {
	const {
		addBodyMouseEvent,
		initialize,
	...
	return (
		<Form onSubmit={handleSubmit(sendFormToAddBody)}>
			<div>
				...
				<Button primary={!invalid} type="submit">
					Add
				</Button>
				<Button

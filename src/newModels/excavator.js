...
function Excavator(props){
  ...
  useEffect(() => {
    ...
    const group = Body.nextGroup(true);
      // add bodies
    const fromVertices = Bodies.fromVertices(210, 410,
      [{"x":145.401,"y":113.73},{"x":141.901,"y":109.73},{"x":86.4014,"y":109.73},{"x":57.337867736816406,"y":112.21636962890625},{"x":28.15367317199707,"y":106.80421447753906},{"x":10.4014,"y":87.7296},{"x":9.440763473510742,"y":84.31266021728516},{"x":8.805326461791992,"y":54.72804260253906},{"x":10.4014,"y":49.2296},{"x":42.4014,"y":15.7296},{"x":59.9014,"y":26.7296},{"x":59.9014,"y":13.2296},{"x":59.11518096923828,"y":9.537083625793457},{"x":47.4014,"y":1.22961},{"x":33.4014,"y":13.2296},{"x":3.90137,"y":45.7296},{"x":1.7057740688323975,"y":56.718650817871094},{"x":2.808957815170288,"y":86.5831069946289},{"x":3.90137,"y":93.2296},{"x":19.8577938079834,"y":109.93138122558594},{"x":48.29899978637695,"y":118.3912582397461},{"x":78.26766967773438,"y":117.91423797607422},{"x":86.4014,"y":117.23}],
        { collisionFilter: { group: group }, label: 'kivsh' }
      );
    const fromVertices1 = Bodies.fromVertices(400, 340,
        ...
        { collisionFilter: { group: group }, label: 'second-part-hand' }
      );
    const fromVertices2 = Bodies.fromVertices(770, 270,
        ...
        { collisionFilter: { group: group }, label: 'first-part-hand' }
      );
    const fromVertices3 = Bodies.fromVertices(1050, 296,
        ...
        { collisionFilter: { group: group }, label: 'main-cabina', mass: 150, }
      );
    const fromVertices4 = Bodies.fromVertices(1000, 455,
        ...
        { collisionFilter: { group: group }, label: 'pidviska',isStatic: false }, false, true
    );

    // World.add(world, [fromVertices]);
    // World.add(world, [fromVertices1]);
    const Constraint42 = Constraint.create(
        {
          "bodyA": fromVertices3,
          "bodyB": fromVertices4,
          "pointA": {
          ...
          "length": 0,
          "label": "Constraint left pidviska",
          "stiffness": 1,
          "damping": 0,
          "render": {
            "visible": true,
    ...
    const Constraint43 = Constraint.create(
        {
          "bodyA": fromVertices3,
          "bodyB": fromVertices4,
          "pointA": {
    ...
    const Constraint45 = Constraint.create(
        {
          "bodyA": fromVertices3,
          "bodyB": fromVertices2,
          "pointA": {
    ...
    const Constraint46 = Constraint.create(
        {
          "bodyA": fromVertices3,
          "bodyB": fromVertices2,
          "pointA": {
      ...
      const Constraint47 = Constraint.create(
          {
              "bodyA": fromVertices2,
              "bodyB": fromVertices1,
              "pointA": {
      ...
      const Constraint48 = Constraint.create(
          {
              "bodyA": fromVertices2,
              "bodyB": fromVertices1,
              "pointA": {
      ...
      const Constraint49 = Constraint.create(
          {
              "bodyA": fromVertices1,
              "bodyB": fromVertices,
              "pointA": {
      ...
      const circleLeft = Bodies.circle(830, 495, 55,
          {
      ...
      const circleRight = Bodies.circle(1170, 495, 55,
          {
              collisionFilter: { group: group },
              label: 'circleRight',
              "density": 0.001,
      ...
      const Constraint50 = Constraint.create(
          {
              "bodyA": fromVertices4,
              "bodyB": circleLeft,
              "pointA": {
      ...
      const Constraint51 = Constraint.create(
          {
              "bodyA": fromVertices4,
              "bodyB": circleRight,
              "pointA": {
      ...
      const rectangleRight = Bodies.rectangle(200, 320, 72, 18,
          {
              "density": 0.001,
              "friction": 0.1,
              "frictionStatic": 0.5,
              "frictionAir": 0.01,
              "restitution": 0,
              "label": "rectangleRigth",
              "isStatic": false,
              collisionFilter: { group: group },
          }
      );
      const rectangleLeft = Bodies.rectangle(170, 350, 18, 72,
          {
              "density": 0.001,
              "friction": 0.1,
              "frictionStatic": 0.5,
      ...
      const Constraint53 = Constraint.create(
          {
              "bodyA": fromVertices,
              "bodyB": rectangleLeft,
              "pointA": {
      ...
      const Constraint54 = Constraint.create(
          {
              "bodyA": rectangleRight,
              "bodyB": rectangleLeft,
              "pointA": {
                  "x": -30,
                  "y": 0
      ...
      const Constraint55 = Constraint.create( {
          "bodyA": fromVertices1,
          "bodyB": rectangleRight,
          "stiffness": 0.1,
          "damping": 0,
          "label": "Constraint",
          "pointA": {
      ...
      const Constraint56 = Constraint.create(
          {
              "bodyA": fromVertices1,
              "bodyB": rectangleRight,
              "pointA": {
    ...
    const staticParam = true;
    World.add(world, [fromVertices2,fromVertices3,fromVertices4, fromVertices1, fromVertices, circleLeft, circleRight,
     rectangleRight, rectangleLeft
    ]);
    Body.setStatic(fromVertices4, staticParam);
    Body.setStatic(fromVertices3, staticParam);
    Body.setStatic(fromVertices2, staticParam);
    Body.setStatic(fromVertices1, staticParam);
    Body.setStatic(fromVertices, staticParam);
    Body.setStatic(rectangleRight, staticParam);
    Body.setStatic(rectangleLeft, staticParam);
    Body.setStatic(circleRight, staticParam);
    Body.setStatic(circleLeft, staticParam);
    World.add(world, [Constraint42, Constraint43, Constraint45, Constraint46, Constraint47, Constraint48,
        Constraint49, Constraint50, Constraint51, Constraint53, Constraint54,
